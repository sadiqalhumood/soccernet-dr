"""
Parse Qwen embedding baseline results JSON and summarize hits by event type.

Usage:
    python qwen/analyze_results.py \
        --results /ibex/scratch/alhumosm/SoccerNet/logs/qwen_emb_baseline_results.json
"""
...
def main():
    ...
    parser.add_argument("--results", required=True, help="Path to qwen_emb_baseline_results.json")
